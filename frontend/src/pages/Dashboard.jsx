    ...
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <main style={{ flex: 1, padding: '32px 40px', overflow: 'auto' }}>
        ...
        <div style={{ marginBottom: 32 }}>
          <h1 style={{ fontSize: 26, fontWeight: 700, color: '#1a5c3a' }}>Dashboard</h1>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ background: '#f9fafb' }}>
                  {['Name','Phone','Insurance Type','Status','Last Contact'].map(h => (
              ...
              <tbody>
                {loading ? (
                  <tr><td colSpan={5} style={{ padding: 24, textAlign: 'center', color: '#888' }}>Loading...</td></tr>
                ) : leads.length === 0 ? (
                  <tr><td colSpan={5} style={{ padding: 24, textAlign: 'center', color: '#888' }}>No leads yet</td></tr>
                ) : leads.map((lead, i) => (
                  <tr key={lead.Id || i} style={{ borderTop: '1px solid #f0f0f0' }}>
                    ...
                    <td style={{ padding: '12px 16px', fontSize: 14, color: '#555' }}>{lead.Interest || lead.insurance_type || '—'}</td>
